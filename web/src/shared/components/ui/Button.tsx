...
const buttonVariants: ButtonVariants = {
    variant: {
        ...
        danger:
            "border border-status-err-fg/30 bg-status-err-bg text-status-err-fg hover:bg-status-err-bg/70",
        outline:
...
export function buttonClasses({ variant = "default", size = "default", className }: { variant?: Variant; size?: Size; className?: string } = {}) {
    return [
