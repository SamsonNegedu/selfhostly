...
function UpdateBadge() {
    ...
    return (
        <Link
            ...
            className="flex h-[44px] items-center gap-2 rounded-lg border border-status-info-fg/30 bg-status-info-bg px-3 text-compact font-medium text-status-info-fg ring-offset-background transition-colors hover:bg-status-info-bg/70 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 md:h-9"
        >
