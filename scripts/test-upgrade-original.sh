...
app_count() {
  ...
  local n; n="$(sqlite3 "$WORK/live/data/selfhostly.db" 'SELECT COUNT(*) FROM apps WHERE name = "kan"')"
...
sqlite3 "$WORK/live/data/selfhostly.db" "INSERT INTO apps (id,name,description,compose_content,status,node_id) VALUES ('a1','kan','','x','running','$NODE_ID_BEFORE')"
